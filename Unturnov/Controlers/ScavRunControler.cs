    ...
    public class ScavRunControler
    {
        ...
        internal static bool tryStopScavRun(UnturnedPlayer player)
        {
                ...
                && StoredStats.TryGetValue(steamId, out PlayerStats stats))
            {
                ...
                {
                    InventoryHelper.forceAddItem(player.Inventory, itemJarWrap.itemJar.item, itemJarWrap.itemJar.x, itemJarWrap.itemJar.y, itemJarWrap.page, itemJarWrap.itemJar.rot);
                }
